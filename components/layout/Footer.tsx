        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/#caracteristicas" className="text-sm hover:text-primary-400 transition-colors">
                  Características
                </Link>
              </li>
              <li>
                <Link href="/#precios" className="text-sm hover:text-primary-400 transition-colors">
                  Precios
                </Link>
              </li>
              <li>
                <Link href="/integraciones" className="text-sm hover:text-primary-400 transition-colors">
                  Integraciones
                </Link>
              </li>
              <li>
                <Link href="/demo" className="text-sm hover:text-primary-400 transition-colors">
                  Solicitar Demo
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/quienes-somos" className="text-sm hover:text-primary-400 transition-colors">
                  Quiénes Somos
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/casos-de-exito" className="text-sm hover:text-primary-400 transition-colors">
                  Casos de Éxito
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/ayuda" className="text-sm hover:text-primary-400 transition-colors">
                  Centro de Ayuda
                </Link>
              </li>
              <li>
                <Link href="/documentacion" className="text-sm hover:text-primary-400 transition-colors">
                  Documentación
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-neutral-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link href="/privacidad" className="text-sm text-neutral-400 hover:text-primary-400 transition-colors">
                Privacidad
              </Link>
              <Link href="/terminos" className="text-sm text-neutral-400 hover:text-primary-400 transition-colors">
                Términos
              </Link>
